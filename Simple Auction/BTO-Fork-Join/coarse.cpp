/********************************************************************
|  *****    Simple Auction BTO Miner + Fork-Join Validator   *****  |
|  *****     File:   coarse.cpp                              *****  |
|  *****  Created:   Sep. 03, 2018, 21:46 PM                 *****  |
*********************************************************************
...
double tTimer[2];              //! total time taken by miner and validator algorithm respectively.
...
//		cout<<" Number of Invalid AUs = "+to_string(numAUs-gNodeCount)+"\n";
	...
	static void concMiner( int t_ID, int numAUs, Graph *cGraph)
	{
		...
		while( curInd < numAUs )
		{
			...
			//! \this.AU.trans_id\ is conflicting.
			list<int>conf_list;
			conf_list.clear();
			...
			if (flag == true) 
			{
				...
				//! statrt clock to get time taken by \this.thread\ 
...
public:
	...
	Validator( )
	{
		...
		vTTime   = new float_t [nThread];//! index location => thread id.
